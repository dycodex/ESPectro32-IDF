...
#define WIFI_SSID_NAME_1        "[WIFI_SSID_NAME_1]"
#define WIFI_SSID_PASS_1        "[WIFI_SSID_PASS_1]"
#define WIFI_SSID_NAME_2        "[WIFI_SSID_NAME_2]"
#define WIFI_SSID_PASS_2        "[WIFI_SSID_PASS_2]"
